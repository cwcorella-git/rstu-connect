...
*Converted from: `./AB121_EN.pdf`*  
*Total pages: 8*  
*File size: 326085 bytes*  
*Converted: Mon Sep  8 02:09:35 PM PDT 2025*
...
AN ACT relating to real property; requiring a landlord or his or her
    ...
    under a rental agreement to be set forth in a certain manner;
...
with a copy of the written rental agreement, if any, to which the prospective tenant
...
exceeds the amount of any fee charged by the operator of the Internet website or
...
charging a tenant an amount of periodic rent that exceeds the amount of rent due
...
tenant. The provisions of this paragraph do not prohibit any
...
shall not charge a tenant an amount of periodic rent that exceeds
...
total amount of periodic rent due required by subsection 6 if:
   (a) The applicable public utility is unable to contract directly
...
applicable public utility that is unable to contract directly with the
...
figure; or
    (b) For a monthly fee in an amount which is equal to the cost
