...
What Microsoft keeps is not exactly a password in the traditional sense; no person ever types it on a terminal. Rather, it is a signature and encryption key that corresponds to a second key stored in your computer. This enables Microsoft, and potentially any web sites that cooperate with Microsoft, the ultimate control over what the user can do on per own computer. Microsoft is likely to use that control on behalf of the FBI when asked: it already [shows the NSA security bugs in](https://www.gnu.org/proprietary/malware-microsoft.html) [Windows](https://www.gnu.org/proprietary/malware-microsoft.html) to exploit.
...
Today's commercial e-books [abolish readers' traditional](https://www.gnu.org/philosophy/the-danger-of-ebooks.html) [freedoms.](https://www.gnu.org/philosophy/the-danger-of-ebooks.html) Amazon's e-book reader product, which I call the ["Amazon Swindle"](https://www.gnu.org/philosophy/why-call-it-the-swindle.html) because it's designed to swindle readers out of the traditional freedoms of readers of books, is run by software with several demonstrated [Orwellian functionalities.](https://www.gnu.org/proprietary/malware-kindle-swindle.html) Any one of them calls for rejecting the product completely:
...
If we want to stop the bad news and create some good news, we need to organize and fight. Subscribe to the FSF's [Defective](https://www.defectivebydesign.org/) [by Design](https://www.defectivebydesign.org/) campaign to lend a hand. You can [join the FSF](https://www.fsf.org/associate) to support our work more generally. There is also a [list of ways to](https://www.gnu.org/help/help.html) [participate in our work.](https://www.gnu.org/help/help.html)

## **References**

- The administration's "White Paper": Information Infrastructure Task Force, Intellectual Property [\[sic\]](https://www.gnu.org/philosophy/not-ipr.html) and the National Information Infrastructure: The Report of the Working Group on Intellectual Property [sic] Rights (1995).
- [An explanation of the White Paper: The Copyright Grab,](https://www.wired.com/1996/01/white-paper/) Pamela Samuelson, Wired, January 1st, 1996.
- [Sold Out,](https://law.duke.edu/boylesite/sold_out.htm) James Boyle, New York Times, March 31, 1996.
- [Public Data or Private Data,](https://web.archive.org/web/20130508120533/http://www.interesting-people.org/archives/interesting-people/199611/msg00012.html) Dave Farber, Washington Post, November 4, 1996.
- [Union for the Public Domain—](https://web.archive.org/web/20151113122141/http://public-domain.org/)an organization which aims to resist and reverse the overextension of copyright and patent powers.
