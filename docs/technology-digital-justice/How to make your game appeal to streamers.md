...
- The content can't be too stressful or overly exhausting -- this is why not many e Sports streamers play normal games and vice-

versa. Games need to have downtime so streamers can interact with their audience. It's difficult to be both entertaining and playing well in a game like Speed Runners as we found.
...
- The commands need to be clear and bundled together. Something like ["#vote](https://www.tinybuild.com/oldblog/hashtags/vote) 1" is easy to vote for item 1. If you have multiple commands, send a clear message how to use it. ["#vote](https://www.tinybuild.com/oldblog/hashtags/vote) 1 100" can be used to "Bet 100 on Option 1"
...
- Go stream some games
- Setup your own game
- See if it works in all major livestreaming apps
