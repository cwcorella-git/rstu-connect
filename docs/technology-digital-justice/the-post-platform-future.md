...
# **The Post-Platform Future [The Decline of Hot Tickets]**
...
- 1. It was expensive to invest in, requiring development and test kits, and very high production expectations
- 2. The marketing story of the platform belonged to the platform
- 3. It required publishing deals to get to market
- 4. The platform holder acted as gatekeeper over content as well as technology
- 5. 95% of game revenue went to people other than the developer
- 6. It provided great distribution reach
- 7. It relied heavily on relationships, which meant that who you knew mattered, but if you had the relationship then you had some protection from the winds of change
- 8. As the platform died, the technological knowledge underneath it died too, so you had to study up for the new platform, or you risked going out of business.
- 9. The platform owned the customer
- 10. The platform protected game content from piracy
- 11. The customer was prepared to pay a premium for what he or she considered to be a premium product
- 12. The industry was structured to drive hits, so a strong launch was vital
- 13. There was a dedicated fan base and media outlets that publicised your game
- 14. Metrics other than sales figures did not exist
...
- 1. It was expensive to invest in because of a technology race and an expectation from consumers
- 2. The marketing story of the platform belonged to the publisher and, to a lesser extent, Microsoft
- 3. It *usually* required publishing deals to get to market
- 4. There were no gatekeepers over technology or content
- 5. 85% of game revenue went to people other than the developer
- 6. It provided less distribution reach, but units were cheaper
- 7. It relied on publisher relationships for finance, but not platform relationships
- 8. The platform was cyclical but never died, which meant knowledge transitioned more readily
- 9. The publisher owned the customer
- 10. Piracy was highly prevalent

- 11. The customer was prepared to pay a premium for what he or she considered to be a premium product
- 12. It was also hit driven, but there was more room for niche and slow-boil hits to emerge
- 13. There was a dedicated fan base and media outlets that publicised your game
- 14. Metrics other than sales figures did not exist
...
- 1. It is inexpensive to invest in, costing the price of a few Macs
- 2. The marketing story of the platform belongs to Steve Jobs
- 3. It doesn't require publishing deals to get to market
- 4. There is a gatekeeper over technology and objectionable content, but not content in general
- 5. 30% of game revenue goes to people other than the developer
- 6. It provides wide distribution reach
- 7. It relies on neither publisher nor platform relationships
- 8. The platform is cyclical but won't die
- 9. Customer ownership is about 50/50 Apple and the developer
- 10. Piracy is not too much of a problem
- 11. The customer is not prepared to pay a premium for what they consider to be a casual product (with one or two exceptions, such as Tom Tom), and seems to prefer in-App purchase to flat fees
- 12. It is visibility driven. If you don't show up as *App of the Week* on the App Store, you're probably screwed.
- 13. There is no definite fan base, and media coverage of your game is unlikely unless you really explode like Angry Birds did.
- 14. Metrics other than sales figures can exist, but their relationship with Apple is fraught
...
- 1. It is both inexpensive to invest in, but expensive to thrive in
- 2. The marketing story of the platform belongs to Mark Zuckerberg
- 3. It doesn't require publishing deals to get to market
- 4. There is no gatekeeper over technology or content, but you might fall afoul of Terms of Service
- 5. 10-30% of game revenue goes to people other than the developer
- 6. It provides colossal distribution reach, but visibility is a huge problem
- 7. It relies on neither publisher nor platform relationships
- 8. The platform is pretty constant but does experience random changes at short notice
- 9. Customer ownership is the developer's
- 10. Piracy is not a problem
- 11. The customer expects the game to be free, and around 1 in 50 of them will then spend inside the game

- 12. It is momentum driven. Whether through paid (advertisements) or free (social graph sharing or cross promotion) channels, you need to market. But to achieve significant growth you have to be *remarkable* and constantly innovating.
- 13. There is no definite fan base, and media coverage of your game is unlikely unless you really explode like Farm Ville did.
- 14. Metrics exist in spades. You can measure everything.
...
Without remarkability on your side, as Angry Birds or Farm Ville had, and lacking significant financing for a more traditional marketing push (which most developers don't have), you'll end up in the digital graveyard, or at best maintaining a small app or two but never likely to accelerate beyond that point.
...
The successful post-platform does not have to be vastly expensive. Wee War, for example, is a very small game made by a small team that is also its own platform. What it does have to be, on the other hand, is *different*. It can't replicate another post-platform and expect success. It either has to vastly over-do the incumbent (as WoW did to Everquest and Facebook did to to Myspace) by scratching the biggest itches that the incumbent has, or it has to do something remarkably different. I don't just mean a little bit differently - and execution still matters a great deal - but significantly different. Post-platform games have to find their place in the sun by defining themselves.

Here's what the traits of the post platform future look like:

- 1. It can be either inexpensive or expensive to invest in and support. Your choice.
- 2. The marketing story of the platform belongs to the developer
- 3. It doesn't require publishing deals to get to market
- 4. There is no gatekeeper over technology or content, but different outlets will have policies to contend with
- 5. 10-30% of game revenue probably goes to people other than the developer until you build your own payment solution
- 6. Reach is your problem, but there will be many venues and ways to achieve it
- 7. It relies on neither publisher nor platform relationships
- 8. The outlets will change, but increasingly adhere to common standards (HTML5, Unity, etc)
- 9. Customer ownership belongs to the developer
- 10. Piracy may or may not be a problem, depending on the product. For services, no. For stand-alone releases, absolutely.
- 11. The customer will expect the game to be free or cheap. Around 1 in 50 of them will then spend inside games with virtual goods if that's the model you use.
- 12. It is conversation driven. Marketing is through social and paid channels, but the presence of players on your platform over the long term will require talking to them and engaging with them as a community.
- 13. There is no definite fan base, and media coverage of your game is unlikely unless you really explode. You will build your fans over time.
- 14. Metrics exist in spades. You can measure everything.
- 15. **You will need to learn how to lead the charge, not follow it.**
...
Posted on 08 December 2010 | [Permalink](https://web.archive.org/web/20250914121151/https://www.whatgamesare.com/2010/12/the-post-platform-future.html)
...
Posted by: [Nicholaslovell](https://web.archive.org/web/20250914121151/https://profile.typepad.com/nicholaslovell) | [13 December 2010 at 01:49 PM](https://web.archive.org/web/20250914121151/https://www.whatgamesare.com/2010/12/the-post-platform-future.html?cid=6a0120a8f8e2b8970b0147e0a8e823970b#comment-6a0120a8f8e2b8970b0147e0a8e823970b)
...
Posted by: [coach outlet](https://web.archive.org/web/20250914121151/http://www.coachbagsmvp.com/) | [06 January 2011 at 10:59 PM](https://web.archive.org/web/20250914121151/https://www.whatgamesare.com/2010/12/the-post-platform-future.html?cid=6a0120a8f8e2b8970b0147e15793d1970b#comment-6a0120a8f8e2b8970b0147e15793d1970b)
