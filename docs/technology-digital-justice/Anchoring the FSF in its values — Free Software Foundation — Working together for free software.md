...
Already in 1985, we could see that many of the people who appreciated the GNU Project's work (developing useful GNU software packages) did not support our goal and values. To look at software issues in terms of freedom was radical and many were reluctant to consider it, so they continued to evaluate programs based on practical convenience. If the FSF were membergoverned, it would soon have hundreds of members who considered our goals and values unimportant and would vote to dispense with them -- if they could. To avoid that sad end, we had to design the organization not to be vulnerable to this danger.

So we chose a [structure](https://www.fsf.org/about/fsf-bylaws) whereby the FSF's governing body would appoint new people to itself.
