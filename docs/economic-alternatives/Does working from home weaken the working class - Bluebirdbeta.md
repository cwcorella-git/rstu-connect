...
Coincidentally,Slack has recently changed their policy about direct messagesso that employers can download them, including deleted messages, without having to inform you. Yes, your boss can read your Slack DMs.

Furthermore, not only were we not expected to chat informally or discuss workplace issues, we were financiallydisincentivisedfrom doing so. We were on the clock after-all, and to talk would mean that our speeds would decrease and we would fall down the ranks. This meant that, to my knowledge at least, none of the workers were able to build close relationships and discuss these blatant problems with the work process.
...
Secondly, companies can leverage surveillance technologies and precarious contracts to create an arbitrary division of labour. The work process was individualised in such a way whereby workers had a financialdisincentiveto have solidarity with their colleagues. This becomes an extremely difficult problem to overcome if, as I have just argued, workers cannot form relationships.
...
Final notes for organisers working from home:

- Anything you send to colleagues online can potentially be copied and sent to the boss.- If you know your colleagues or worked with them before lockdown, reach out to them and form a communication infrastructure outside the eyes of the boss. This could be a list of fellow workers' email and phone contacts, or a whatsapp group for trusted workers and friends.- If you are made aware of new employees being hired and working from home, try to contact them in a chatty way, get to know them.- If you have started a new job where you work from home, you need to find a way to talk with colleagues. Without pre-existing relationships this could be quite awkward! This may actually be easier if there are a large number of new workers, as everyone will be in the same boat.- Try to find if your company has a list of colleagues' email addresses and phone numbers.- Lockdown will eventually end, though it seems likely you and your workmates will still be working from home. You could try to organise social events for people to meet up.- In a situation with intensive surveillance, where worker communication is disincentivised, an external campaign might be more appropriate to ensure your safety.
...
I imagine it's mostly work that can be done remotely that is shifting in that direction, whether permanently or temporarily. I think there's also a "white versus blue collar" aspect here too, in that it's predominantly the "hands-on" workers who are stuck in their covid factories/warehouses/workplaces, while so-called professional workers, who are typically also the more loyal to their companies and the less precarious and radical, are the ones doing "home work" (would be interested if there are places where that is not the case and where employers have adapted differently?). Precarious data entry contract workers (and others like office workers) are obviously different. The pitting of workers against one another with these nonsense competitions of "who can work the hardest/assemble the most widgets/do this bullshit thing the fastest" is also obviously nothing new, but I see how the shift to "home work," where workers' every action is tracked via software, can/has led to greater intensity of remote work, along with all the stress and mental health issues that come with that. There's also places like Amazon warehouses, and other places, where workers' productivity is already closely tracked using technology and software, as well as transportation workers too.
