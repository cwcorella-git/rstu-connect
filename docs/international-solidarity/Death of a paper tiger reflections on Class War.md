...
| and I should just do it myself.) I do really respect the honesty that went into that one. |
|---------------------------------------------------------------------------------------------------------|
| Steven. |
| 15 years 10 months ago |
| In reply to Welcomebylibcom.org |
...
internally; but these contradictions were never allowed to surface publicly, so as to preserve a

'sussed' group public image. This is the opposite of what is necessary - rather than the working class itself searching for an adequate theory and practice by confronting openly its own contradictions, instead a political faction attempting to recruit people around a false image of unity which is the result of repressed contradictions. If these criticisms and
