...
Lynd’s view of the prevailing “contract unionism” differs from standard labor history, which considers the 1935
...
has advocated for decades. Non-union workers can form independent unions based on solidarity unionism principles. We may also see more hybrid types of organizing, such as the
fast food
and

## OUR Walmart

campaigns, sponsored by mainstream unions, and based in part on workplace actions. Some labor radicals are encouraged by these campaigns as something new, but Lynd reminds us that they recreate older forms of organizing, at least to the extent that they involve genuine worker leadership rather than stage-managed media events.
