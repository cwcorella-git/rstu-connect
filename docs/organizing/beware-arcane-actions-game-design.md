...
[Featured](https://web.archive.org/web/20250914153152/https://www.whatgamesare.com/featured-posts.html) [Glossary](https://web.archive.org/web/20250914153152/https://www.whatgamesare.com/glossary.html) [About](https://web.archive.org/web/20250914153152/https://www.whatgamesare.com/about.html) [Consulting](https://web.archive.org/web/20250914153152/https://www.whatgamesare.com/consulting.html)
...
Game [mechanics](https://web.archive.org/web/20250914153152/http://whatgamesare.com/2010/12/game-dynamics-vs-game-mechanics.html) are fuzzy. Nobody quite agrees what they are, everybody has their own interpretation of what they mean and they are rarely specific. They are a design-side view of a game, and talk more about the interplay of elements and guessed-at understanding of why the game might be fun.
...
An action is a press of a button (or a sequence of buttons, wave of a controller, click of a mouse etc) that causes a single and visible effect in the game world. Pulling a trigger, pushing a control stick, selecting a unit with your mouse, equipping a spell and twisting a [tetromino](https://web.archive.org/web/20250914153152/https://en.wikipedia.org/wiki/Tetris) are all kinds of actions.
...
When the player moves from room to room in Portal there are often pyrotechnics triggered by her arrival. That kind of trigger is not an action, however, because it's not deliberate. It's a [condition](https://web.archive.org/web/20250914153152/http://whatgamesare.com/2011/02/constraints-constants-and-conditions-game-rules.html) for which the game is quietly monitoring. Actually pushing a button as a part of a puzzle to make something happen? That's an action.
...
An innovative action also needs to be robust, with the designer cleverly figuring out ways to make the game world more interesting while leaving the basic actions simple. In a previous post, I called this extending through [environment,](https://web.archive.org/web/20250914153152/http://whatgamesare.com/2011/01/extensible-actions-game-design.html) and it's important. Games whose actions do not extend in some way (environment is one example) become quickly boring. If your game is going to bet the farm on a new kind of action then it really needs to be all about that action all of the time.

Finally, an innovative action needs to explore one [kind](https://web.archive.org/web/20250914153152/http://whatgamesare.com/2011/06/all-good-games-are-tests-but-not-vice-versa.html) of test in various ways to achieve an appropriate level of [dimensionality](https://web.archive.org/web/20250914153152/http://whatgamesare.com/2011/06/is-your-game-one-dimensional-design.html). Portal 2, for example, introduces fluids which allow for bouncy or speedy behaviours, adding more dimensions to the basic puzzles. This is excellent design.
...
On the other hand the test in Street Fighter 4 is all about timing and muscle memory, and so is taught through learned patterns. The closed arena environment constrains the rest of the game to remove all other distractions, and so the player can [master](https://web.archive.org/web/20250914153152/http://whatgamesare.com/2011/02/cars-dolls-and-video-games-narrativism.html) a doll. Take that arena constraint away and place the game in a more open environment (God of War for example) and the same complexity of fighting engine has to be toned down because there are other types of test to consider.
...
(Today's image comes from Weird [Universe.](https://web.archive.org/web/20250914153152/http://www.weirduniverse.net/blog/permalink/contortionists/))

Posted on 03 August 2011 | [Permalink](https://web.archive.org/web/20250914153152/https://www.whatgamesare.com/2011/08/beware-arcane-actions-game-design.html)
...
You can follow this conversation by subscribing to the [comment feed](https://web.archive.org/web/20250914153152/https://www.whatgamesare.com/2011/08/beware-arcane-actions-game-design/comments/atom.xml) for this post.
