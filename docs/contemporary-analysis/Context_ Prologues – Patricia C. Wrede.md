...
The Raven Ring prologue also takes advantage of the slight speed-bump that many readers experience when going from a prologue to the "real" opening of the book. There's a twomonth time-skip and a change in viewpoint between the prologue and Chapter One, which would feel awkward and a bit odd if it came between Chapter One and Chapter Two.

Between a prologue and Chapter One, though, the change emphasizes the gap in time and place between the prologue and the rest of the book.
