...
Che's notion of "absorption" is simply when a "force attacks the enemy for a period of time and then breaks off the attack being absorbed into the

## 1 of 2 8/29/25, 11:06 AM

community or environment" from where it came. Pulsing is a constant flow of people joining, breaking up and rejoining, often in new combinations of groups. The most successful way this can be done is through small decentralized autonomous groups (e.g. affinity groups) that have the decisionmaking power to decide for themselves when and with whom to interact with.
...
Retrieved on June 11, 2009 from [www.lahaine.org](https://www.lahaine.org/global/dk2002/swarm_action.htm)
