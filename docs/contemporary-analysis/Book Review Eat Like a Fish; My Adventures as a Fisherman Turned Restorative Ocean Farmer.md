...
| More than anything else, the book will leave the reader hopeful, in the proactive sense. It's yet |
|---------------------------------------------------------------------------------------------------|
| another account that shows that workers directly working in any industry can find solutions to |
| overcome its destructiveness and oppressiveness by eliminating the influence of capitalism. |
