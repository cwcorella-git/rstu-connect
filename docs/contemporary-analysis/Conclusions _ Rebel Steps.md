...
A good example of this idea in practice is ["From Antiglobe To](https://itsgoingdown.org/from-antiglobe-to-antifa-a-recent-history-of-anarchist-struggle-in-nyc/) [Antifa: A Recent History Of Anarchist Struggle In NYC,](https://itsgoingdown.org/from-antiglobe-to-antifa-a-recent-history-of-anarchist-struggle-in-nyc/)" a project directly inspired by "Fighting Collective Amnesia" that's available via It's Going Down. It documents some of the movements and notable actions that happened in New York from 2008-2018.
