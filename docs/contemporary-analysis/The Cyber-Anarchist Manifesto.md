...
By anarchist spirit [we] mean that deeply human sentiment, which aims at the good of all, freedom and justice for all, solidarity and love among the people; which is not an exclusive characteristic only of self-declared anarchists, but inspires all people who have <sup>a</sup> generous heart and an open mind.
...
> Join us. Together, we will be unstoppable.

Retrieved on December 20, 2024 from [<af2c.org/manifesto.html>](https://af2c.org/manifesto.html) AF2C expects this text will be expanded on in the future.
