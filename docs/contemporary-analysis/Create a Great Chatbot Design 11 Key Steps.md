...
Chatbots with performance issues create stigma: [According to our](https://www.userlike.com/blog/consumer-chatbot-perceptions) [research, 6](https://www.userlike.com/blog/consumer-chatbot-perceptions)0% of participants say that chatbots fail to resolve their issues and users rather speak to a human than a bot to answer service questions. Fair enough, but this perception can be improved.
...
- 1. [Determine your bot's purpose](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#purpose)
- 2. [Choose a rule-based or NLP platform](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#platform)
- 3. [Know the limitations of your platform](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#platform-limitations)
- 4. Defi[ne personality and tone](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#persona-and-tone)
- 5. [Text like a human](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#human)
- 6. [Design the](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#design-flow) flow
- 7. [Integrate visuals and downloads](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#visuals)
- 8. [Educate users on bot commands](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#commands)
- 9. [Find a balance between proactive and reactive](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#proactive-and-reactive)
- 10. [Make it easy to switch from bot to human support](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#bot-to-human)
- 11. [Use an intuitive chatbot design platform](about:reader?url=https%3A%2F%2Fwww.userlike.com%2Fen%2Fblog%2Fchatbot-design#chatbot-platform)
...
| | cha | atbot | J | |
| 1. | They' | re cool | | |
| 2. | They | do the w | ork f | or me |
| 3. | it do | esn't nee | d suf | pervisio |
| 4. | make | s my comp | any | look |
| | high- | tech | | |
| δ. | it's ki | ind of fre | e | |
| 6. | They | can send | gifs | and |
| | stuff | | | |

UI Designer [Saumya Srivastava](https://www.lollypop.design/blog/2018/january/designing-a-chatbot/) stresses:
...
IF user's input contains 'shop' or 'buy' THEN send message with product list Bots with Natural Language Processing (NLP) are able to understand the context even when questions are more complex. Thanks to their ability to learn from their mistakes, they improve with every inquiry.

Take our [AI Automation Hub, f](https://www.userlike.com/en/blog/ai-automation-hub)or example. Answers are pulled from a central knowledge base, which improves itself over time the more users interact with the AI chatbot, intelligent FAQ page or contact form.

## ![](_page_4_Figure_2.jpeg)

Userlike's AI Chatbot is available to users on all their favorite channels, and learns from every conversation.
...
# [Read more](https://www.userlike.com/blog/chatbots)

Some (especially younger) platforms like [Think Automation e](https://www.thinkautomation.com/)xpect you to input questions and answers in a coded format, which requires a certain affection for coding to enjoy using them.
...
Userlike's AI chatbot comes with prewritten texts to common questions with the option to easily edit or add your own.

If you need more help understanding the different chatbot platforms, or to get an overview of the top providers on the market, check out our post, ["11 must-try chatbot providers for every](https://www.userlike.com/en/blog/chatbot-providers) [budget."](https://www.userlike.com/en/blog/chatbot-providers)
...
Our recent study of [consumer chatbot perceptions s](https://www.userlike.com/blog/consumer-chatbot-perceptions)howed us that people prefer bots with human traits. We asked:
...
But how do you create a humanlike personality for a chatbot? Try using screenwriting principles. First, define the role your bot plays (its purpose), then create a short background story: What's your bot's motivation, what's its specialty, what are its striking character traits? And not to forget, what name fi[ts this persona?](https://www.userlike.com/en/blog/chatbot-persona)
...
Wittiness works great for a trendy company like Apple, but it really isn't for every brand, as an article published by [The Manifest p](https://chatbotslife.com/how-to-give-your-chatbot-a-personality-5e0fb239b28c)oints out: "Don't feel pressured to program humor or street-smarts for audiences that don't crave those traits. A simple, helpful, and polite robot is the best choice for many brands."

Need inspiration for your chatbot UX design? Here's some articles you may find useful:

- [5 steps to a catchy bot name](https://www.userlike.com/en/blog/bot-names)
- [6 steps for creating a smooth chatbot conversation](https://www.userlike.com/en/blog/chatbot-conversation-flow) flow
- How to fi[nd the right chatbot persona for your brand](https://www.userlike.com/en/blog/chatbot-persona)
- [5 examples of fantastic chatbot UI](https://www.userlike.com/en/blog/chatbot-ui)
...
[Vaibhav Verma, U](https://chatbotsmagazine.com/@vaibhavverma)I designer for chatbots, suggests the following: "Taking up the user's name frequently, greeting him, congratulating him etc. are some practices, which make conversations more personalized."
...
Use images, [brand logos, i](https://www.hubspot.com/brand-kit-generator/free-logo-maker)cons, and other visual graphics in a carousel to highlight important pages on your website. For example, your products, services and FAQ pages. Users will have the combination of a quick visual overview of what you offer and can easily click on and explore what's most interesting to them with a chatbot on screen to answer their questions.

## ![](_page_12_Picture_3.jpeg)

Some chatbot providers, such as [Userlike, e](https://www.userlike.com/)ven let you send downloads directly in the chat. Whether it be a shipping label, prescription or registration confirmation, a chatbot can send important documents without the help of an agent.
...
If you decide to use a [proactive approach, i](https://www.userlike.com/en/blog/proactive-live-chat)t's best to have the chat window pop up in an unobtrusive spot. According to the [Gutenberg](https://medium.com/user-experience-3/the-gutenberg-diagram-in-web-design-e5347c172627) [Diagram, t](https://medium.com/user-experience-3/the-gutenberg-diagram-in-web-design-e5347c172627)he bottom right corner works best. This will help keep visitors from closing the window before the chatbot can do its thing.
...
For some more tips, [check out our post o](https://www.userlike.com/blog/proactive-live-chat)n how to use proactive chat effectively.
...
Luckily, you have many options for creating professional bot prototypes to showcase your design. [Here is a list of bot](https://chatbotbusinessframework.com/chatbot-mockup-tools-prototyping/) [prototyping tools y](https://chatbotbusinessframework.com/chatbot-mockup-tools-prototyping/)ou may find useful.

If you want to skip prototyping and build a bot you can preview before making it live, consider tools like the [AI Automation Hub o](https://www.userlike.com/en/blog/ai-automation-hub)r [IBM Watson, w](https://www.ibm.com/watson)hich let you preview your chatbot within the software before it's available to your users. That way you can actually chat with your bot in a live demo instead of just showing a chat concept.
...
At [Userlike, w](https://www.userlike.com/)e wanted to make intelligent automation attainable for every business. That's why we created the AI Automation Hub as part of our live chat and customer messaging solution. It eliminates the need to use a third party software, and is easy for anyone to use, from your support agents to your marketing team. Anyone can design an engaging chatbot.

## ![](_page_19_Picture_12.jpeg)

## ![](_page_20_Figure_2.jpeg)

Userlike gives you a chatbot that can talk to your customers on all their favorite channels from one inbox.

Instead of planning scenarios, the AI Chatbot is connected to a [central knowledge base l](https://www.userlike.com/en/blog/chatbot-knowledge-base)oaded with your business data. It uses this information to talk to your customers and deliver the best answer. It's self-learning, which means its conversations improve over time, and not just through chatbot conversations.
...
| First name Julia My E-Mail | Last name |
|------------------------------------------------------------------------------------------------------|-------------------------|
| Julia | |
| | - 1 |
| My F-Mail | Gonzales |
| IVIY L-IVIGII | |
| j.gonzales@email.com | |
| - Your message | AB |
| Hi! | ( १३) |
...
If you're getting started with chatbot architecture design and development, our AI Automation Hub will make your life easier. Test it out for free for two weeks by [signing up for a free Userlike](https://www.userlike.com/en/register) [trial. D](https://www.userlike.com/en/register)on't worry, we don't need a credit card for you to test.

If you're having an easy time using our product, get in touch with our support team [on our website o](https://www.userlike.com/)r send us an email at support@userlike.com to discuss your chatbot and automation plans further. We look forward to getting you set up with intelligent automation for your business!
