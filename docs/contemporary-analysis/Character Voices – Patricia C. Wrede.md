...
If you want to practice, come up with some specific, really offthe-wall dialog rules–ones that mean the speaker will be instantly identifiable–and then take a conversation from one of your stories. Assign each character a set of rules and rewrite the conversation. Then swap the rules and rewrite the same conversation again.
