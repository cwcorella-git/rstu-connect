...
Labor Network for Sustainability, et. al.
...
## The EV transition cannot be a "

race to the bottom

" that further exploits workers. We call on you to honor the demands of the UAW.
...
| For an updated list of endorsing organizations, |
|-------------------------------------------------|
| this site |
| |
## | Disclaimer: |
