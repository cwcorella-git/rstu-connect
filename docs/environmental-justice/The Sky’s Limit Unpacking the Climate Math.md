...
| prominent |
| individuals |
| have joined the choir to spread the word about the report. |
| As George Monbiot |
| writes |
| in |
| The Guardian |
| , the report presents three scenarios for moving forward: |
## | |
