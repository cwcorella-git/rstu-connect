...
One cannot ignore the question of racism when a mostly white town can get the pipeline moved but the concerns of Indigenous people are not met with the same consideration.

Furthermore, construction of this pipeline in the planned location would also break the 1868 Fort Laramie Treaty.
