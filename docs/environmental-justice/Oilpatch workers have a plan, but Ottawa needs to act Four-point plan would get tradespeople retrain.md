...
## Upskilling for the energy sector workforce

More manufacturing capacity for renewable energy in Canada

Support for contractors and unions that want to transition to renewables

Integrating renewable technologies into existing energy projects
...
| We want to see workers and families thrive. We want the green energy revolution to bring us | |
|---------------------------------------------------------------------------------------------|--|
| closer to financial security and our climate targets — all at the same time. | |
