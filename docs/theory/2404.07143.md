---
title: "Leave No Context Behind: Efcient Innite Context Transformers with Inni-attention"
category: "theory"
---
...
Figure 1: Inni-attention has an additional compressive memory with linear attention for processing innitely long contexts. {KV}s−1 and {KV}s are attention key and values for current and previous input segments, respectively and Qs the attention queries. PE denotes position embeddings.
