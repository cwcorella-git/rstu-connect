...
In response to the rapid urbanization of [Vietnam](https://www.designboom.com/tag/architecture-in-vietnam/), the architects at [Vo Trong Nghia \(VTN\)](https://www.designboom.com/tag/vo-trong-nghia-architects/) complete a lush Urban Farming [Office](https://www.designboom.com/tag/where-people-work/). The project is built in remembrance of the untouched tropical forests that once sprawled across the country, but have now become crowded and over-polluted cities. 'New generations in urban areas are losing their connection with nature,' the architects tell designboom. 'The country is facing changes as it moves to a manufacturing based economy, taking its toll on the environment. Increased droughts, floods and salinization jeopardize food supplies.'

## ![](_page_1_Picture_2.jpeg)

images © [Hiroyuki Oki](https://www.instagram.com/oki.hiroyuki.47)

#### reconnecting with vietnam's natural roots

The recently completed Urban Farming Office now stands as the studio space for Vo Trong Nghia Architects. The building was designed to reconnect with the natural roots of its site — a newly developed area in Ho Chi Minh City. Thus, the architecture reintroduces green space to the city while promoting safe food production with a [facade](https://www.designboom.com/tag/facades/) overgrown with plant-life.

The facade takes shape as an assembly of suspended planter boxes hosting various native plants and facing broadly out toward the sun. The [architects](http://vtnarchitects.net/) explain: 'This green approach will provide safe food and comfortable environment with minimum energy consumption, contributing to the sustainable future of city.'
