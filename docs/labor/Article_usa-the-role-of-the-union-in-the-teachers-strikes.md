...
## ASInternationalist Workers’ Group, USA
...
Guys, can you change this image to something that doesn't have white blocks on either side? As it is, we can't put this article on the front page and it likely wouldn't get shared very much on social media as the image is of such a low quality.
If you could upload a bigger, higher quality image without those white blocks on the sides that would be greatly appreciated.
