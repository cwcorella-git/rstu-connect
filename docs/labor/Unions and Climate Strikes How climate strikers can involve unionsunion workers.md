...
(below and right; click on the image to view and download a PDF of either or both).

Unions have engaged in strikes for the environment since the 1970s, known as green bans. However:

While it is tempting to believe we can create enough buzz to convince enough workers to actually engage in work stoppages (actual workplace strikes) on September 20, 27, or any

| suggested that a "strike" for the climate (e.g. |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
## this video from England has similar suggestions).
...
Bakers Food & Allied Workers Union (UK) - May 2019 (
link
)
...
ΙWW GreROC (Greece), September 16, 2019 - (
link
)
IWW NARA (US) - Bay Area (California) General Membership Branch; September 5, 2019
IWW NARA (US) - Denver (Colorado) General Membership Branch, September 3, 2019
IWW WISERA (UK) - (
link
)
...
University and College Union (UK) - May 25, 2019 (
link1
link2
)
Verdi (Germany) - (
...
Earth Strike is the "general strike to save the planet" associated with Extinction Rebellion and approach(es)). We recommend keeping up with all of them:

radical left figures. It is called for September 27th -
