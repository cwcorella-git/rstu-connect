            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              {!isPastDate && (
                <button
                  ...
                  className="text-sm text-rstu-red hover:text-red-700 font-medium"
                >
                  + Create an event
                </button>
              )}
        ...
        {!isPastDate && (
          <div className="px-4 py-3 border-t border-gray-200 bg-gray-50 flex-shrink-0">
            ...
            >
              ...
              Create Event for {date.toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
            </button>
          </div>
        )}
      </div>
