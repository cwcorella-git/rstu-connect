    ...
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      ...
      <div className="border-b border-gray-200">
        <div className="flex">
          ...
          >
            {t('profile.appGovernance') || 'App Governance'}
            {isDelegate && (
    ...
    <div className="space-y-4">
      ...
      {isDelegate && (
        <div className="flex gap-2">
          ...
          >
            {showCreateForm ? (t('common.cancel') || 'Cancel') : (t('profile.createProposal') || 'Create Proposal')}
          </button>
          <button
      ...
      <div>
        <h4 className="text-sm font-semibold text-gray-700 mb-2">
          {t('profile.activeProposals') || 'Active Proposals'} ({activeProposals.length})
        </h4>
      ...
      {showHistory && historyProposals.length > 0 && (
        <div>
          <h4 className="text-sm font-semibold text-gray-700 mb-2">
            {t('profile.proposalHistory') || 'Proposal History'} ({historyProposals.length})
          </h4>
          <div className="space-y-3">
    ...
    return (
      <div className="p-3 bg-purple-50 rounded-lg border border-purple-200">
        ...
        <p className="text-xs text-purple-700">
          {t('profile.bookchinNote') || 'Admins cannot vote on governance (power flows from tenants)'}
        </p>
      </div>
    )
  }
    ...
    <div className={`p-3 rounded-lg border ${
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-medium">
          {isDelegate
            ? (t('profile.delegateStatus') || 'Delegate Status') + ': Qualified'
            : (t('profile.qualificationProgress') || 'Qualification Progress')}
        </span>
        {isDelegate && (
