...
export function UserDropdown({ userInitial, userName, onOpenAdmin }: UserDropdownProps) {
  const { t } = useLanguage()
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      <button
        ...
        className="w-10 h-10 rounded-full bg-gradient-to-br from-rstu-red to-red-700 flex items-center justify-center text-white font-bold text-sm hover:shadow-md transition-shadow"
        title={userName}
