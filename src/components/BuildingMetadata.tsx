...
export function BuildingMetadata({ building }: BuildingMetadataProps) {
  ...
  if (!isVisible) {
    return (
      <button
        ...
        className="absolute top-4 left-4 bg-white/90 px-3 py-2 rounded shadow-lg text-xs text-gray-600 hover:bg-white transition"
      >
        Show building info
      </button>
    );
  ...
  return (
    <div className="absolute top-4 left-4 bg-white/95 p-4 rounded shadow-lg max-w-sm z-10">
