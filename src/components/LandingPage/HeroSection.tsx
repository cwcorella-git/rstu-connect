...
export function HeroSection({ onScrollClick, onEnter }: HeroSectionProps) {
  ...
  return (
    <section className="relative px-4 bg-white min-h-[calc(100vh-64px)] flex flex-col">
      <div className="max-w-3xl mx-auto text-center flex flex-col flex-1 justify-center w-full">
        ...
        <EditableText
          ...
          as="p"
          className="text-sm sm:text-base text-gray-600 max-w-xl mx-auto mb-4 sm:mb-6 leading-relaxed"
          multiline
        />
      ...
      <button
        onClick={onScrollClick}
        className="text-gray-400 hover:text-gray-600 transition-colors mx-auto block pb-4"
