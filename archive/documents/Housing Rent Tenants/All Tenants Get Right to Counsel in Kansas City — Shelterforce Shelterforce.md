...
#### [Tenant Power Returns](https://shelterforce.org/series/tenant-power-returns)
...
Kansas City, Missouri, now guarantees access to legal representation for tenants facing eviction, and it's one of a small but growing number of cities making that right available to all tenants, regardless of income. Effective as of June 1, the city [ordinance](https://clerk.kcmo.gov/View.ashx?M=F&ID=10392649&GUID=3E8229E7-800F-4D06-9741-55F4E7BC15C7) passed in late 2021, capping off a brief but intensive campaign by a [large coalition](https://docs.google.com/document/d/1ykw QcirEQ1ewOHm2zEJf4hy5Qpyzqw3E1C3Q5m8MbkA/edit) of tenant and worker rights organizations and legal aid groups.

The Kansas City campaign rolled forward rapidly, with advocates—led by KC Tenants, Stand Up KC, Missouri Workers Center, and the Heartland Center for Jobs and Freedom coming together in September 2021 and legislation passing three months later. But organizers say the seeds were planted back in 2019, the year Kansas City passed a [tenant bill of](https://www.kcmo.gov/city-hall/housing/tenant-resources) [rights.](https://www.kcmo.gov/city-hall/housing/tenant-resources)
...
Kansas City already had an eviction problem before the pandemic. While KC Tenants came together only recently, in 2019, its founder and executive director, Tara Raghuveer, had spearheaded eviction research for years prior to that through the [Kansas City Eviction Project.](https://www.evictionkc.org/project) Data from that research helped advocates build a strong case for bolstering tenant rights. The sheer number and consistency of eviction filing rates—some 9,000 per year from 1999 to 2016—suggested to researchers that some Kansas City landlords may even have eviction built into their business model. In addition, racial justice was at play, with the city's Black tenants impacted disproportionately by eviction.

The [ordinance](https://clerk.kcmo.gov/Legislation Detail.aspx?ID=5346395&GUID=E90D634A-EB7C-4A49-B73A-C8D7C2D31354&Options=&Search=) lists some compelling statistics: In a 10-year period up to 2016, eviction was the outcome in 99.8 percent of the 76,667 eviction cases adjudicated in Jackson County, the largest of the four counties Kansas City comprises. Moreover, there was severe disparity in legal representation: Tenants were represented only 3 percent of the time, while landlords had counsel in more than 85 percent of cases, a power mismatch closely mirroring [national data.](https://civilrighttocounsel.org/uploaded_files/280/Landlord_and_tenant_eviction_rep_stats__NCCRC_.pdf)

'When you walk into a courtroom now, it's just a different day, a balancing of justice that's a lovely thing to see.'

Counsel alone doesn't stop evictions, but [data](https://civilrighttocounsel.org/uploaded_files/283/RTC_Enacted_Legislation_in_Eviction_Proceedings_FINAL.pdf) from across the U. S. shows that tenants with representation in eviction cases are far more likely to stay in their units, be granted more time when moving is necessary, and leave court with a clean eviction record.

"There is no case—not one—where you don't need an attorney," says John Pollock, coordinator of the National Coalition for a Civil Right to Counsel (NCCRC). "Even when the tenant simply didn't pay and the court decides to evict, it still has to decide three things: Is the eviction going to be [on the](https://civilrighttocounsel.org/major_developments/1110#:~:text=91%25%20of%20Shriver%20cases%20ended%20with%20the%20eviction%20record%20sealed) [tenant's record?](https://civilrighttocounsel.org/major_developments/1110#:~:text=91%25%20of%20Shriver%20cases%20ended%20with%20the%20eviction%20record%20sealed) How much of a rent judgment will be given? And how much time does the tenant have before vacating? Those are really key to whether the person can get housing again later."
...
They crafted an ordinance that covers all tenants, without restrictions on income or family structure. That inclusivity is [not](https://nlihc.org/resource/louisville-city-council-passes-renter-right-counsel-joins-nine-other-us-cities) [the case with all right to counsel laws,](https://nlihc.org/resource/louisville-city-council-passes-renter-right-counsel-joins-nine-other-us-cities) though it's becoming a more common demand, NCCRC's Pollock says, as it addresses a broader need and helps vanquish stigma that guaranteed counsel is a benefit only for the poor. Of the 15 cities that now have passed tenant right to counsel, five others have no income restrictions: San Francisco, Boulder, Baltimore, Minneapolis, and New Orleans. "In the jurisdictions without an income limit, there's one less barrier to obtaining an attorney for an eviction case than in a criminal case," says Pollock.
...
Working with the Heartland Center, the tenant advocates calculated that the city needed to commit \$2.5 million annually to provide attorneys and administer the program. Federal pandemic relief dollars will cover the first year, and for the future, the program has a line in the [city budget.](https://www.kcmo.gov/home/showpublisheddocument/8546/637903814535600000) "That was a big deal," Kilpatrick says, "because it gives it more of a guarantee that it will stay around."
...
Evidence is growing that providing counsel is cost-effective policy. One analysis for [Baltimore](https://bmorerentersunited.org/wp-content/uploads/2020/05/Baltimore-RTC-Report_FINAL_5.8.2020.pdf) predicted that every \$1 spent on counsel for low-income tenants can save the city and state \$3 to \$6 on eviction-related social services such as emergency shelter and school transportation services. The Kansas City advocates presented similar research for [Los Angeles](https://info.stout.com/hubfs/PDF/Eviction-Reports-Articles-Cities-States/Los%20Angeles%20Eviction%20RTC%20Report_12-10-19.pdf) that estimated every \$1 invested could reap \$3.48 in cost savings.
...
Sabrina Davis in front of the Kansas City home she used to rent. Photo by Carlos Moreno/KCUR 89.3. Used with permission

Another key strategy was having residents who have faced eviction share their stories.
...
Having a lawyer on her side, Davis recalls, "was like an elephant had decided to stand up off my chest and let me breathe a bit." And this time [she won,](https://www.kcur.org/news/2021-10-20/a-kansas-city-tenant-fights-back-and-wins-rare-victory-against-landlord-who-tried-to-evict-her) gaining the rent she had paid and her security deposit back.
...
As tenant right to counsel gains momentum across the U. S., advocates can learn from prior efforts. The Right to Counsel NYC Coalition has created a comprehensive [toolkit](https://www.rtctoolkit.org/) to assist others. This fall, NCCRC, in partnership with Results for America, the Heartland Center and other organizations, is leading a [series of webinars](https://results4america.org/solutions-accelerator-sprint/) on advancing right to counsel in cities, counties, and states.
...
**This article is part of** [Tenant Power Returns](https://shelterforce.org/category/tenant-power-returns/)**, an Under the Lens series produced by Shelterforce. If you're enjoying the series, consider making a donation to our newsroom.** [Donate Today.](https://secure.lglforms.com/form_engine/s/vkNWFx DvpDQuDXP7BkLIHA)

#### **About the Author**

#### [Sandra Larson](https://shelterforce.org/author/sandra-larson)
